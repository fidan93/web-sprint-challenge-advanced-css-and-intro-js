...
if(artists[8].name !== 'Vincent Van Gogh'){
...
function addArtist(arr,name,years,genre,nationality,bio){
   arr.push({name:name,years:years,genre:genre,nationality:nationality,bio:bio});
   return arr;
  }
console.log(addArtist(artists,'Abidin Dino','1913 - 1993','Abstract expressionism','Turkish','The art world is known to feature great artists from different walks of life, there have been very few Ottoman artists who managed to make an impact and Abidin Dino was one of them. At the ripe age of 20 Dino founded the D Group of artists and six years later he founded the Liman Group. '))
