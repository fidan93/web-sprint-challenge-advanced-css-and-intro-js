...
Accessibility if for instance browser could find anything on page if someone uses buttons to navigate. Browser can easily red html if it was used semantic tags.which have meaning.
2. Talk about 3 different things you can do to ensure your website is accessible. 
Use right colors, font. use semantic tags
3. How would you explain the concept of a variable to someone new to programming?
variable is like a box in which you want to store data;
4. What is the purpose of using functions in code?
functions is some kind activity. we use functions if we want do something.
